...
namespace BlueMonsterLabs.ModernUI.App.Content
{
    /// <summary>
        ...
        : NotifyPropertyChanged
    {
        ...
        public SettingsAppearanceViewModel()
        {
            ...
            this.themes.Add(new Link { DisplayName = "bing image", Source = new Uri("/BlueMonsterLabs.ModernUI;component/Assets/ModernUI.BingImage.xaml", UriKind.Relative) });
            this.themes.Add(new Link { DisplayName = "hello kitty", Source = new Uri("/BlueMonsterLabs.ModernUI;component/Assets/ModernUI.HelloKitty.xaml", UriKind.Relative) });
            this.themes.Add(new Link { DisplayName = "love", Source = new Uri("/BlueMonsterLabs.ModernUI;component/Assets/ModernUI.Love.xaml", UriKind.Relative) });
            this.themes.Add(new Link { DisplayName = "snowflakes", Source = new Uri("/BlueMonsterLabs.ModernUI;component/Assets/ModernUI.Snowflakes.xaml", UriKind.Relative) });

using BlueMonsterLabs.ModernUI.Windows.Navigation;
using System;
using System.Linq;
...
namespace BlueMonsterLabs.ModernUI.Presentation
{
        ...
        : NotifyPropertyChanged
    {
        ...
        /// </summary>
        public static readonly Uri DarkThemeSource = new Uri("/BlueMonsterLabs.ModernUI;component/Assets/ModernUI.Dark.xaml", UriKind.Relative);
        /// <summary>
        /// The location of the light theme resource dictionary.
        /// </summary>
        public static readonly Uri LightThemeSource = new Uri("/BlueMonsterLabs.ModernUI;component/Assets/ModernUI.Light.xaml", UriKind.Relative);
